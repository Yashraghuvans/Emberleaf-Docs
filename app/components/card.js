...
const Card = ({data,reference}) => {
    return (
        <motion.div drag dragConstraints={reference} className='h-72 w-60 rounded-[45px] bg-gray-900/90 text-white py-10 px-8 relative overflow-hidden flex-shrink-0'>
            <FaRegFileAlt/>
